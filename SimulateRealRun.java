...
public class SimulateRealRun {
   ...
   // 0 for unexplored; 1 for visited; 2 for empty space but not visited ; 3 for obstacle; 5 for goal
     ...
     public  SimulateRealRun(int[] strP,double coverage_limit,int[][] occupancy,long time_limit){
...
//***************************Check whether can align***********************************************  
   ...
   //**********************Robot Command****************************************************  
     ...
     public void moveForward(){
         ...
         //robot command
         System.out.println();
         System.out.println("send to robot: W|");
         client.write("W|");
     }
     ...
     public void turnLeft(){
         ...
         //robot command
          System.out.println();
         System.out.println("send to robot: A|");
         client.write("A|");
     ...
     public void turnRight(){
         ...
         //robot command
          System.out.println();
        System.out.println("send to robot: D|");
        client.write("D|");
     }
     ...
     public void doAlignment(){
         ...
         //robot command
          System.out.println();
         System.out.println("send to robot: Q|");
         client.write("Q|");
